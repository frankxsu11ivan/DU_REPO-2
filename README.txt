...
## Analysis and Challenges
	...
	The challenge is working thrugh the code to run  complex analyses as I was deconstructing the probelm and debugging. The challenge that i encountered were realizing when to close if loops inside for then loops.
### Results
	the challenge i was getting to the results. With a bit of tenacity the code was finnaly realy for 'F5' and did not want to go further.
